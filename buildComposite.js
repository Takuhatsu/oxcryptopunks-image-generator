...
// const { maxSupply } = require('./config.js');
...
//   const compositeImage = new Jimp(24 * row, maxSupply / row * 24, 0x00000000); // Set background color to fully transparent.
...
//     // Stop processing if we have reached the maximum limit.
//     if (i === maxSupply) {
//       break;
//     }
//   }
